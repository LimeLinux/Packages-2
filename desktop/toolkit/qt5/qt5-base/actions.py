...
def setup():
    ...
    vars = {"limelinux_CC" :       get.CC() + (" -m32" if get.buildTYPE() == "emul32" else ""),
            "limelinux_CXX":       get.CXX() + (" -m32" if get.buildTYPE() == "emul32" else ""),
            "limelinux_CFLAGS":    filteredCFLAGS + (" -m32" if get.buildTYPE() == "emul32" else ""),
            "limelinux_LDFLAGS":   get.LDFLAGS() + (" -m32" if get.buildTYPE() == "emul32" else "")}
